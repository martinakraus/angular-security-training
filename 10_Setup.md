...
1. Clone the demo Repo `git clone https://github.com/martinakraus/angular-security-2026`.
2. Install the dependencies: `cd angular-security-2026` and `npm install`
